...
export default function VerificationMargin({ claims, selectedClaimId, hoveredClaimId, onClaimClick, onClaimHover, onCollapse }: VerificationMarginProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-[#F8F8F7] border-l border-[#E8E8E6]">
      {/* Header */}
      <div className="h-9 px-3 border-b border-[#E8E8E6] flex items-center justify-between flex-shrink-0">
      ...
      {/* Status bar */}
      {claims.length > 0 && (
        <div className="px-3 py-2 border-b border-[#E8E8E6] flex gap-3 flex-shrink-0">
      ...
      {/* Refresh */}
      {claims.length > 0 && (
        <div className="p-2 border-t border-[#E8E8E6] flex-shrink-0">
