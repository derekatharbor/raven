// src/app/solutions/consulting/page.tsx
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 px-10 md:px-16 py-16 md:py-24">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold leading-[1.1] tracking-tight">
                Client deliverables that don't unravel.
              </h1>
            </div>
            ...
            <div className="flex flex-col justify-end">
              <p className="text-lg text-white/60 mb-4 leading-relaxed">
                Build client presentations with AI that shows its work. Every insight backed by data with complete source trails.
              </p>
              <p className="text-lg text-white/60 mb-8 leading-relaxed">
                From research to final deck—Raven helps teams move faster without sacrificing credibility.
              </p>
              <div>
                <Link 
                  href="/contact"
        ...
        {/* IMAGE: /public/images/marketing/solutions/consulting-hero.png */}
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="ml-5 md:ml-6 mr-5 md:mr-6">
            <img 
              src="/images/marketing/solutions/consulting-hero.png" 
              alt="Raven for Consulting"
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="px-10 md:px-16 py-16 md:py-20">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight max-w-2xl">
              Generic AI fails consulting teams because...
            </h2>
          </div>
        </div>
          ...
          <div className="ml-5 md:ml-6 mr-5 md:mr-6 grid grid-cols-2 md:grid-cols-5">
            <div className="h-[236px] p-6 md:p-8 border-r border-b md:border-b-0 border-white/10 flex items-center justify-center text-center">
              <p className="text-base md:text-lg font-medium text-white leading-snug">
                Partners will ask where every number came from
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3">
              ...
              <div className="md:col-span-2 md:pl-8">
                ...
                <div id="feature-citations" className="py-16 md:py-24 border-b border-white/10">
                  ...
                  {/* IMAGE: /public/images/marketing/solutions/consulting-feature-citations.png */}
                  <img 
                    src="/images/marketing/solutions/consulting-feature-citations.png"
                ...
                <div id="feature-confidence" className="py-16 md:py-24 border-b border-white/10">
                  ...
                  {/* IMAGE: /public/images/marketing/solutions/consulting-feature-confidence.png */}
                  <img 
                    src="/images/marketing/solutions/consulting-feature-confidence.png"
                ...
                <div id="feature-audit" className="py-16 md:py-24 border-b border-white/10">
                  ...
                  {/* IMAGE: /public/images/marketing/solutions/consulting-feature-audit.png */}
                  <img 
                    src="/images/marketing/solutions/consulting-feature-audit.png"
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="px-10 md:px-16 py-24 md:py-32 text-center">
            ...
            <p className="text-lg text-white/60 mb-8 max-w-xl mx-auto">
              See how Raven can help your team build better client deliverables.
            </p>
            <Link 
              href="/contact"
